...
class Letters(Scene):
    def construct(self):
        eq_sign = Tex("=").set_color(BLACK).scale(4)
        plus_sign = Tex("+").set_color(BLACK).scale(4)
        twenty_six = Tex("26").set_color(BLACK).scale(4)

        self.wait(1)
        self.play(FadeIn(eq_sign))
        self.wait(1)
        self.play(FadeOut(eq_sign))
        self.wait(1)
        self.play(FadeIn(plus_sign))
        self.wait(1)
        self.play(FadeOut(plus_sign))
        self.wait(1)
        self.play(FadeIn(twenty_six))
        self.wait(1)
        self.play(FadeOut(twenty_six))
        self.wait(1)
